                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
						...
						<ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="selected" href="graph2.php">Soil Moisture & Silo Storage</a>
                            </li>
                        </ul>
                    </li>
					<li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-62">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <center><img src="assets/img/chart3.png"></center></div>
                        </div>
                    </div>
                    <!-- End Area Chart -->
                </div>
                ...
                <div class="col-lg-62">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Grains present in the Silos
                        </div>
                        <div class="panel-body">
                            <center><img src="assets/img/chart4.png"></center>
						</div>
                    </div>
                    </div>
                    <!-- End Area Chart -->
