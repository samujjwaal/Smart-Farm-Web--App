    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
					...
					<li>
                        <a class="selected" href="tables.php"><i class="fa fa-files-o fa-fw"></i>Crop Support</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Crop Support</h1>
                </div>
				<div class="row">
                <div class="col-lg-12">
                    <!-- Advanced Tables -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Crops of Suitable District 
                        </div>
     
<div class="panel-footer">
                            <div class="input-group">
                                <form role="form" method="GET" action="tables1.php">
								<input id="btn-input" type="text" class="form-control input-sm" name="district" type="type" placeholder="Type District..." autofocus/>
                                <input id="btn-input" type="text" class="form-control input-sm" name="season" type="type" placeholder="Type Season..." autofocus/>
