            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
						...
						echo "<tr><th>Crop Year</th><th>Crop Name</th><th>Area</th><th>Production</th></tr>";
...
try {
    ...
    $stmt = $conn->prepare("SELECT Year, Name, Area, Production FROM crops WHERE District='$district' && Season='$season'"); 
    $stmt->execute();
