    ...
    <div id="wrapper">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="selected" href="alert.php">Alerts</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
      ...
      <div id="page-wrapper">
            <div class="row">
                <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">All Alerts</h1>
                </div>
                 <!--end  page header -->
            </div>
            <div class="row">
                <div class="col-lg-61">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<div class="alert alert-success">
                                 <div>
                                    <i class="fa fa-shopping-cart fa-fw"></i>New Order Placed with Dealer
                                    <span class="pull-right text-muted small"><em>9:49 AM</em></span>
                                </div>
                            </div>
							<div class="alert alert-info">
                                <div>
                                    <i class="fa fa-envelope "></i>Message Sent to Expert
                                    <span class="pull-right text-muted small"><em>9:30 AM</em></span>
                                </div>
                            </div>
							<div class="alert alert-success">
                                <div>
                                     <i class="fa fa-upload "></i>Yesterday's data uploaded to Server
                                    <span class="pull-right text-muted small"><em> AM</em></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Error Reports</h4>
                                        </div>
                                        <div class="modal-body">
                                            <strong>No Errors Reported so far..</strong>
                                        </div>
